...
export const resourceReports = [
  {
    ...
    discription: 'Data science is the study of data to extract meaningful insights for business. It is a multidisciplinary approach that combines principles and practices from the fields of mathematics, statistics, artificial intelligence, and computer engineering to analyze large amounts of data.',
    iconBg: '#FF0000',
    pcColor: 'red-600',
  },
...
export const folderDistribData = [
  { x: 'data science', y: 0, text: '35%' },
  { x: 'quantum computing', y: 0, text: '15%' },
  { x: 'algorithms', y: 0, text: '25%' },
  { x: 'blockchain', y: 10, text: '25%' },
];
