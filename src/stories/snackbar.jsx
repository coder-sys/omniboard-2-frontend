...
export default function Row({sourcename,sender,reciever,message}) {
  ...
  const handleYes = async() =>{
    let api = await fetch(`http://127.0.0.1:5000/add_folder/${metaData['firstname']+metaData['lastname']+metaData['email']}/${sourcename} shared by ${sender}`)
    api = await api.json();
